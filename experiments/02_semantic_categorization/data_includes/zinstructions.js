...
newTrial("instructions2",
    ...
    newText("For example, the word <b>KITTEN</b> generally has CONCRETE associations.")
        .print()
        .center()
    ,
    newText("Therefore you should press the button corresponding to <b>CONCRETE</b>.")
        .center()
        .print()
    ,
    newText("<br>")
        ...
        .print()
    ,
    newText("In contrast, the word <b>DEATH</b> generally has ABSTRACT associations.")
        .center()
        .print()
    ,
    newText("Therefore you should press the button corresponding to <b>ABSTRACT</b>.")
        .center()
        .print()
    ,
    newText("<br>")
