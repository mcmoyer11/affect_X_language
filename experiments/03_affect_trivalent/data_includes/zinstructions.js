newTrial("instructions1",
    ...
    newText("In the following experiment, you will see words presented one after the other.")
        ...
        .print()
    ,
    newText("Your job is to categorize each word as <b>POSITIVE</b>, <b>NEGATIVE</b>, or <NEUTRAL>.")
        .center()
        .print()
    ,
    newText("<br>")
        .print()
    ,
    newText("You can answer by pressing the corresponding <b>F</b>, <b>J</b> or <b> SPACE BAR</b> key on your keyboard.")
        .center()
        .print()
    ,
...
newTrial("instructions2",
    ...
    newText("<br>")
        ...
        .print() 
    ,
    newText("Finally, the word <b>ICE</b> generally has NEUTRAL associations.")
        .center()
        .print()
    ,
    newText("In other words, it's neither positive or negative without more information.")
        .center()
        .print()
    ,
    newText("Therefore you should press the button corresponding to <b>NEUTRAL</b>.")
        .center()
        .print()
    ,
    newText("<br>")
