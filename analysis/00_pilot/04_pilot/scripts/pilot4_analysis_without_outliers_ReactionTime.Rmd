...
```{r, include=FALSE, warning=FALSE, echo=FALSE}
contrasts(df_factors$ConcValFinal)
...
m = lmer(LogReactionTime ~ cTask*ConcValFinal + (1+ConcValFinal+cTask|ID.true) + (1+cTask|Word), data=center)
...
# Does AccuracyCorrected predict reaction time? 
